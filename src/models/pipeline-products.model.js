...
module.exports = function(app) {
  ...
  pipelineProducts.associate = function(models) {
    ...
    pipelineProducts.hasMany(models.pipelines, {
      foreignKey: 'id_pipeline',
      sourceKey: 'id_pipeline'
    })
    pipelineProducts.hasMany(models.products, { foreignKey: 'id_product', sourceKey: 'id_product' })
    pipelineProducts.hasMany(models.customers, {
      foreignKey: 'id_customer',
      sourceKey: 'id_customer'
    })
    pipelineProducts.hasMany(models.subproducts, {
      foreignKey: 'id_subproduct',
      sourceKey: 'id_subproduct'
    })
